 ...
 function Seating(){
  ...
  const selectSeatsByDefault = (el) => {
    ...
    if(updatedSelectedSeats.length===quantity){
      // updatedSelected seats ko null karo 
    }
      ...
      // loop not required ----sirf ek row check karna hai 
      // look ke kya condn pe stop hoga-empty, booked, last seat, maxcount, unavalable
      for (let i = 0; i < 2; i++) {
